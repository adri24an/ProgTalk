...
\todo{AB:Aquí introducimos un ejemplo de comunicación, indicando en el dibujo que es cada cosa.}
...
\todo{AH: presentación del lenguaje con ejemplos y al final la gramática.}
...
\todo{AH: diagramas UML que representan los conceptos del lenguaje.}
...
Para la implementación de esta parte del analizador semántico hemos usado un patrón \textit{Visitor}.\todo{Añadir libro del que sacamos el patrón visitor.}
