...
\todo{ver si es obligatorio que los mensajes sean estrictamente secuenciales o no.}
\end{itemize}
...
\begin{itemize}
\item \textit{instance} (Identificador de instancia) \textit{of} (Tipo de la instancia) \{ (Parámetro name) \}
\end{itemize}
donde:
\begin{itemize}
\item \textit{instance}, \textit{of}, ''\{'' y ''\}'' son palabras reservadas del lenguaje, y
\item (Identificador de instancia), (Tipo de la instancia), y (Parámetro name) deben ser introducidos por el usuario.
\end{itemize}
