...
\todo{AB:esto es lo que querías? Una referencia a la sintaxis
  abstracta del capítulo de Diseño? O quieres que ponga aquí mismo la
...
\todo{AB: aquí habría que formatear esto hacia la derecha. Pasa igual
  mas arriba y mas abajo en un par de sitios.}
\begin{lstlisting}
...
\todo{AB: de la pagina 15 a la 16 se ve como de repente el margen
  izquierdo pasa a ser más grande... PORQUE?}
\begin{itemize}
