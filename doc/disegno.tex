...
\todo{Enlazar conceptos con su explicación en intromsc}
...
\item La clase \textit{Instance} representa las instancias de la
  comunicación.
\item La clase \textit{Message} representa los mensajes de la
  comunicación.
...
\item La clase \textit{Timestamp} representa los tiempos en que se
  efectúan los eventos. Como vimos estos pueden ser absolutos
  (\textit{Absolute}) o relativos (\textit{Relative}).
\end{itemize}
