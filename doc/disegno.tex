...
En la figura \ref{fig:fig2} se muestra el diagrama de clases de
nuestra herramienta.
...
\todo{AH: describir el patrón Visitor en un párrafo.}

\todo{AH: describir nuestra propia implementación de visitor empezando
  con el diagrama UML en el que se ve el visitor, la estructura
  visitada y las operaciones del Visitor}
